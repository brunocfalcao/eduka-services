...
<span class="preheader-text" style="color:transparent;height:0;max-height:0;max-width:0;opacity:0;overflow:hidden;visibility:hidden;width:0;display:none;mso-hide:all;">Thank you for subscribing to Mastering Nova!</span>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
  <tbody><tr>
    <td height="50" style="font-size:20px;line-height:50px;">&nbsp;</td>
  </tr>
  <tr>
...
<!-- Content -->
  ...
  <tr>
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
      <tbody><tr style="">
        <td class="center-text" align="center" style="font-family:'Barlow', Arial, Helvetica, sans-serif;font-size:24px;line-height:48px;font-weight:700;font-style:normal;color:#1ca37b;text-decoration:none;letter-spacing:0px;">

              <div style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">THANKS FOR SUBSCRIBING</p></div>

        </td>
      </tr>
      <tr style="">
        <td align="center">
          <img style="width:50px;border:0px;display:inline!important;" src="https://modulescomposer.s3.us-east-2.amazonaws.com/blue/arrow.png" width="50" border="0" alt="arrow">
        </td>
      </tr>
      <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" align="center" class="row container-padding" width="90%" style="width:90%;max-width:90%;">
          ...
          <tr>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
              <tbody><tr>
                <td align="center">
                  <img class="auto-width" style="display:block;width:100%;max-width:140px;border:6px solid #FFFFFF;border-radius:100%;" width="86.4" src="{{ Storage::disk('course')->url($subscriber->course->filename_twitter) }}" border="0" alt="picture">
                </td>
              </tr>
            </tbody></table>
            <!-- column -->
            ...
            <td class="rwd-col" align="center" valign="top" width="79.53" style="width:79.53%;max-width:79.53%;">
              ...
              <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="100%" style="width:100%;max-width:100%;">
                <tbody><tr style="">
                  <td class="center-text" align="left" style="font-family:'Arial', Arial, Helvetica, sans-serif;font-size:18px;line-height:24px;font-weight:400;font-style:normal;color:rgb(51, 51, 51);text-decoration:none;letter-spacing:0px;">

                        <div style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">Hi there!</p><br><p style="margin: 0px; padding: 0px;">Thanks a lot for subscribing to my Mastering Nova course! Cannot wait to share it with you and to offer you a very special discount coupon on the launch date!</p><br><br><p style="margin: 0px; padding: 0px;">You'll be the first to know when it will be launched.</p>
                          <br><br><p style="margin: 0px; padding: 0px;">My best,</p><br><p style="margin: 0px; padding: 0px;">Bruno Falcao</p></div>
  ...
  <!-- blue-email-message -->
</tbody></table><table data-outer-table="" border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row container-padding" role="presentation" width="640" style="width:640px;max-width:640px;">
  <!-- blue-send-email -->
  <tbody><tr>
    <td height="10" style="font-size:10px;line-height:10px;">&nbsp;</td>
  </tr>
  <tr>
    <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;line-height:26px;font-weight:400;font-style:italic;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">

          <div style="margin: 0px; padding: 0px;"><p xmlns="http://www.w3.org/1999/xhtml" style="margin: 0px; padding: 0px;"><u><a href="https://www.masteringnova.com" target="_blank" style="text-decoration: none;">www.masteringnova.com</a></u></p></div>
